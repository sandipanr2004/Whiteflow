...
function SocialIcons() {
  return (
    <>
      <a href={`${import.meta.env.VITE_AUTH_URL || 'http://localhost:8081'}/oauth2/authorization/google`} className="social-icon">
      ...
      <a href={`${import.meta.env.VITE_AUTH_URL || 'http://localhost:8081'}/oauth2/authorization/github`} className="social-icon">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
